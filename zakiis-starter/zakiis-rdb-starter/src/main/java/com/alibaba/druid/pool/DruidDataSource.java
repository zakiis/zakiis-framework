    ...
    public void init() throws SQLException {
        ...
        try {
            ...
            if (this.id > 1) {
                ...
                DruidAbstractDataSource.connectionIdSeedUpdater.addAndGet(this, delta);
                DruidAbstractDataSource.statementIdSeedUpdater.addAndGet(this, delta);
                DruidAbstractDataSource.resultSetIdSeedUpdater.addAndGet(this, delta);
                DruidAbstractDataSource.transactionIdSeedUpdater.addAndGet(this, delta);
            }
...
//                Arrays.fill(connections, poolingCount - removeCount, poolingCount, null);
            	// Can't guarantee need remove connection is in the end of the array, we need find it precisely. 
            	DruidConnectionHolder[] healthConnections = new DruidConnectionHolder[poolingCount - removeCount];
            	int evictIndex = 0;
                ...
                for (int i = 0; i < poolingCount; i++) {
                	...
                	if (!needRemove) {
                		healthConnections[tmpConnectionIndex++] = connections[i];
                	}
                }
                System.arraycopy(healthConnections, 0, connections, 0, healthConnections.length);
                Arrays.fill(connections, healthConnections.length, poolingCount, null);
